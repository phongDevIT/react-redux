        ...
        <div className="w-[400px] bg-white p-3 rounded-2xl shadow dark:bg-slate-900">
            ...
            <div className="card-content">
                ...
                <p className="mb-5 text-sm text-slate-600 card-desc dark:text-slate-100">
                    ...
                    Saepe quo hic quos quidem optio, placeat consequuntur dolore
                    molestiae repudiandae iste perspiciatis vel quibusdam alias
                    ducimus eveniet, magnam sed itaque explicabo.
                </p>
                <a
                    href="/#"
